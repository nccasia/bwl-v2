        ...
        <div className="px-[48px] py-4 md:py-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="group relative">
              <div className="absolute inset-[-2px] rounded-full bg-brand-gradient opacity-10 group-hover:opacity-30 transition-opacity" />
              <UserAvatar
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-1.5">
                <span className="font-bold text-foreground text-[15px] hover:text-brand-start transition-colors cursor-pointer">
